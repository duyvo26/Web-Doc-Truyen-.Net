...
namespace WebTruyenV6.Code
{
    public class HeThong
    {
        ...
        public static string TuNhayCam(string text)
        {
            return text;
            //string raw = text;
          //  text = LocDauTiengViet(text).ToLower();
           // text = LocKyTuDatBiet(text).ToLower();
            // chuoi thanh mảng
           ...
           // str = str + ",Fuck, fuck you, son of bitch, asshole, kiss my ass, ass, dick, pussy, boob, niple, suck my dick, bitch, bitch, fucking , suck, motherfucker, nigga, nigger, shit";
           // var tho_tuc = str.Split(',');
           // str = String.Join(",", tho_tuc);

            //bool LocThoTuc = false;
           // foreach (string txt in tho_tuc)
           // {
            //    if (text.Contains(LocDauTiengViet(LocKyTuDatBiet(txt.ToLower()))) == true)
            //    {
           //         LocThoTuc = true;
           //     }
           // }
