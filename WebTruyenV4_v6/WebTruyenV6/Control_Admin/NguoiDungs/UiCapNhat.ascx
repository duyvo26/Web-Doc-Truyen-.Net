<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UiCapNhat.ascx.cs" Inherits="WebTruyenV6.Control_Admin.NguoiDungs.UiCapNhat" %>
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class="bi bi-file-earmark-ppt"></i></span>
                                <img width="100px" src="<%=WebTruyenV6.Code.HeThong.url() %>/public/img/www/avatar/<%=IMG %>"  />
