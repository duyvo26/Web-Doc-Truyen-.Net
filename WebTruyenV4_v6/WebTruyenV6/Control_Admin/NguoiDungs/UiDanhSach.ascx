<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UiDanhSach.ascx.cs" Inherits="WebTruyenV6.Control_Admin.NguoiDungs.UiDanhSach" %>
<div class="card">
    <div class="card-header">
        ...
        <a href="<%=WebTruyenV6.Code.HeThong.url() %>/cp-admin/nguoidung/them">
