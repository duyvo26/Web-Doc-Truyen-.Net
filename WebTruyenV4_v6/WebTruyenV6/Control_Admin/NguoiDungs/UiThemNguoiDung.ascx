<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UiThemNguoiDung.ascx.cs" Inherits="WebTruyenV6.Control_Admin.NguoiDungs.UiThemNguoiDung" %>
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <asp:TextBox ID="taikhoan" runat="server" class="form-control" ></asp:TextBox>
