<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UiDanhSach.ascx.cs" Inherits="WebTruyenV6.Control_Admin.TheLoais.UiDanhSach" %>
<div class="card">
            ...
            <div class="modal-content">
               ...
               <div class="modal-body">
                  ...
                  <div class="input-group">
                     <asp:TextBox ID="tentheloai" runat="server" class="form-control"></asp:TextBox>
                  </div>
                  <label> Mô tả thể loại: </label><br>
                  <div class="input-group">
                     <asp:TextBox ID="motatheloai" runat="server" class="form-control"></asp:TextBox>
                  </div>
               </div>
