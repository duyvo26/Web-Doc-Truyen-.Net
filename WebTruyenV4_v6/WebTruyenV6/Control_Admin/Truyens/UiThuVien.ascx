<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UiThuVien.ascx.cs" Inherits="WebTruyenV6.Control_Admin.Truyens.UiThuVien" %>
<div class="card">
         ...
         <table id="example1" class="table table-bordered table-striped dataTable dtr-inline" aria-describedby="example1_info">
            <thead>
               <tr>
                  ...
                  <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Tài khoản mua truyện">Tài khoản</th>
                  ...
                  <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Tình trạng truyện">Thời gian mua</th>
               </tr>
            </thead>
            <tbody>
               <% for (int i = 0; i < thuvien.Count; i++)
                  { %>
               <tr class="odd">
                  <td><%=LoadNameTruyen(thuvien[i].id_truyen) %></td>
                  <td><%=LoadName(thuvien[i].id_user) %></td>
                  <td>#<%=thuvien[i].id_user %></td>
                  <td><%=LoadCoin(thuvien[i].id_truyen) %></td>
