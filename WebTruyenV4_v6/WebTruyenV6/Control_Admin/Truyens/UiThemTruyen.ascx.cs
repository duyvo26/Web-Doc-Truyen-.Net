        ...
        public void UpLoadTruyen()
        {
            if (!string.IsNullOrEmpty(Request.Form["btn-them"]))
            {
                ...
                else
                {
                    ...
                    string scriptText = "alert('Đăng truyện " + tentruyen.ToString() + " thành công '); window.location='" + Request.ApplicationPath + "cp-admin/truyen/danhsach" + "'";
