<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UiDangKy.ascx.cs" Inherits="WebTruyenV4.Control_NguoiDung.TaiKhoan.UiDangKy" %>
<script>
...
<section>
    <div class="box_div">
        <!--Thanh tiêu đề --> 
        <div class="div_title" >
            <img src="<%=Request.Url.GetLeftPart(UriPartial.Authority) %>/public/img/www/top-icon/login.png"  width="40"/> Đăng ký <!-- da sua thanh 2 cham  -->
        </div>
        <!--End thanh tiêu đề --> 
