<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UiCapNhatNguoiDung.ascx.cs" Inherits="WebTruyenV4.Control_NguoiDung.TaiKhoan.UiCapNhatNguoiDung" %>
<script>
...
<section>
    <div class="box_div maunen_div">
        <div class="div_title">
            <img src="<%=Request.Url.GetLeftPart(UriPartial.Authority) %>/public/img/www/top-icon/contact-list.png" width="40" />
            Thông tin tài khoản
            <!-- da sua thanh 2 cham  -->
        </div>
        <div class="row">
        ...
        <% if(string.IsNullOrEmpty(Request.QueryString["MatKhau"])){ %>
                <form method="POST"EncType="multipart/form-data" action="#">
                    <div class="form-group" style="width: 100%">
                        ...
                        <div style="margin-top: 10px"></div>
                        <div class="form-group" style="width: 100%">
                            <input type="file" name="UploadedFile" value="Tải ảnh bạn muốn đổi" />
                        </div>
                    </div>
                    <div class="form-group" style="width: 100%">
