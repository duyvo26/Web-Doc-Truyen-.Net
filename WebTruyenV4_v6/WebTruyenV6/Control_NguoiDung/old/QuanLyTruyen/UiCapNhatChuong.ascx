<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UiCapNhatChuong.ascx.cs" Inherits="WebTruyenV4.Control_NguoiDung.QuanLyTruyen.UiCapNhatChuong" %>
<script>
...
<section class="box_div maunen_div">
    ...
    <form class="nhap-truyen " method ="post">
        ...
        <div class="d-flex justify-content-end" style="margin-bottom: 5px; margin-right: 5px">
            <a href="<%=Request.Url.GetLeftPart(UriPartial.Authority) %>/taikhoan/danhsachchuong-<%=Chuongs.id_truyen %>">
