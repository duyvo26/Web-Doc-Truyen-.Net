<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UiThemTruyen.ascx.cs" Inherits="WebTruyenV4.Control_NguoiDung.QuanLyTruyen.UiThemTruyen" %>
...
<section class="box_div maunen_div">
    <div class="div_title">
        <img src="<%=Request.Url.GetLeftPart(UriPartial.Authority) %>/public/img/www/top-icon/books.png"  width="40"/>Đăng truyện mới <!-- da sua thanh 2 cham  -->
    </div>
    <!-- form them truyen -->
