<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UiThemChuong.ascx.cs" Inherits="WebTruyenV4.Control_NguoiDung.QuanLyTruyen.UiThemChuong" %>
<script>
...
<section class="box_div maunen_div">
    <!-- Thêm tiêu đề -->
    <div class="div_title">
        <img src="<%=Request.Url.GetLeftPart(UriPartial.Authority) %>/public/img/www/top-icon/books.png"  width="40"/> <%=infoTruyen.ten_truyen%>: - Thêm chương <!-- da sua thanh 2 cham  -->
    </div>
    <!-- End thêm tiêu đề -->
    ...
    <form class="nhap-truyen" method ="post">
        ...
        <div class="d-flex justify-content-end" style="margin-bottom:5px;margin-right:5px">
            <a href="<%=Request.Url.GetLeftPart(UriPartial.Authority) %>/taikhoan/danhsachchuong-<%=infoTruyen.id_truyen %>">
