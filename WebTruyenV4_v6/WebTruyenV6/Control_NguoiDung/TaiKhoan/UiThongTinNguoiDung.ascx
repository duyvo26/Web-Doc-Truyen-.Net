<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UiThongTinNguoiDung.ascx.cs" Inherits="WebTruyenV6.Control_NguoiDung.TaiKhoan.UiThongTinNguoiDung" %>
<script>
...
<section class="box_div maunen_div">
   <div class="div_title">
      <img src="<%=WebTruyenV6.Code.HeThong.url() %>/public/img/www/top-icon/personal-information.png"  width="40"/>Thông tin người dùng <!-- da sua thanh 2 cham  -->
   </div>
         ...
         <div class="col-sm-4">
            <div class="d-flex justify-content-center">
               <div class="avatar-nguoidung">
                  <img class="img-avatar" width="250" src="<%=WebTruyenV6.Code.HeThong.url() %>/public/img/www/avatar/<%= NguoiDungs.img_user %>" onError="this.onerror=null;this.src='<%=WebTruyenV6.Code.HeThong.url() %>/public/img/www/avatar/avatar.jpg';" />
         ...
         <div class="col-sm-8">
            <ul class="list-group ">
               <li class="list-group-item">
                  <div class="lis_truyen"><strong>Id tài khoản:</strong>&nbsp;#<%= NguoiDungs.id_user %> </div>
               </li>
               <li class="list-group-item">
               ...
               <li class="list-group-item">
                  <div class="lis_truyen"><strong>Ngày đăng ký:</strong>&nbsp; <%= NguoiDungs.created_at.ToString("MM/dd/yyyy HH:mm:ss") %></div>
               </li>
            </ul>
         </div>
      </div>
   ...
   <div class="but-nguoidung ">
      <a href="<%=WebTruyenV6.Code.HeThong.url() %>/taikhoan/capnhat">
         <!-- da sua thanh 2 cham  -->
         <button type="button" class="btn btn-info">Cập Nhật Tài Khoản</button>
      </a>
      <a href="<%=WebTruyenV6.Code.HeThong.url() %>/taikhoan/themtruyen">
         <!-- da sua thanh 2 cham  -->
...
<section class="box_div maunen_div">
   <div class="row">
      <div class=" col-sm-8 ">
         <div class="div_title">
            <img src="<%=WebTruyenV6.Code.HeThong.url() %>/public/img/www/top-icon/books.png"  width="40"/>Truyện đã đăng <!-- da sua thanh 2 cham  -->
         </div>
         <!-- in ra thong bao -->
            ...
            <div class="row list_truyen">
               ...
               <div class="col-6 col-sm-4 col-md-4 col-lg-4 col-xl-3" style="margin-top: 2rem;">
                  <div class="card">
                     <span class="btn-truyennguoidung" >
                        <div class="dropdown" style="padding: 0px 0px;">
                           ...
                           <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                              <a class="dropdown-item" href="<%=WebTruyenV6.Code.HeThong.url() %>/taikhoan/capnhattruyen-<%=TruyenDaDang[a].id_truyen %>">Chỉnh sửa truyện</a><!-- da sua thanh 2 cham  -->
                              <a class="dropdown-item" href="<%=WebTruyenV6.Code.HeThong.url() %>/taikhoan/danhsachchuong-<%=TruyenDaDang[a].id_truyen %>">Danh sách chương</a><!-- da sua thanh 2 cham  -->
                     ...
                     <a href="<%=WebTruyenV6.Code.HeThong.url() %>/truyen/<%=TruyenDaDang[a].link_raw+ "-" + TruyenDaDang[a].id_truyen %>">
                        <!-- da sua thanh 2 cham  -->
                 
                   <% if (Convert.ToInt32(TruyenDaDang[a].status_) == 0){ %>
                  ...
                  <% }else{ %>
               <img class="card-img-top" src="<%=WebTruyenV6.Code.HeThong.url() %>/public/img/truyen/<%=TruyenDaDang[a].img_truyen %>"  onError="this.onerror=null;this.src='<%=WebTruyenV6.Code.HeThong.url() %>/public/img/www/err-img.png';" />
                    <% } %>

                           </a>
                     <div class="card-body" style="font-weight: 600; font-size: 16px">
                        <a title="<%=TruyenDaDang[a].ten_truyen %>" href="<%=WebTruyenV6.Code.HeThong.url() %>/truyen/<%=TruyenDaDang[a].link_raw+ "-" + TruyenDaDang[a].id_truyen %>">
                           <!-- da sua thanh 2 cham  -->
                           <!-- chỉnh sửa dòng 83 -->
                           <% RutGon_TieuDe(TruyenDaDang[a].ten_truyen, 40); %>
                        </a>
                     </div>
                  </div>
               </div>
      ...
      <div class=" col-sm-4">
         ...
         <div class="div_title" >
              <div id="giaodich"></div>
            <img src="<%=WebTruyenV6.Code.HeThong.url() %>/public/img/www/top-icon/dollar.png"  width="40"/><!-- da sua thanh 2 cham  -->
            Giao dịch
         </div>
         <!-- phan noi dung -->
         <div class="maunen_div">
            <div class="row list_truyen">
               <div class="list-binhluan_index" >
                  <%int tongDoanhthu = 0;
                     for (int a = 0; a < LogTruyen.Count; a++)
                     {
                     %>
                   <%try {%>
                  <div class="row">
                     <div class="col-8">
                        <p>
                           <% 
                         if (LogTruyen[a].id_user_nhan == NguoiDungs.id_user)
                         {
                             tongDoanhthu = tongDoanhthu + Convert.ToInt32(LogTruyen[a].coin);
                         }
                                %>
                           <p>
                               Id Chuyển:&nbsp;<%= Convert.ToInt32(LogTruyen[a].id_user_chuyen)%>
                           </p>
                            <p>
                               <%= "Coin:&nbsp;" + string.Format("{0:#,##0}", Convert.ToDecimal(LogTruyen[a].coin))  %>
                        </p>
                     </div>
                     <div class="col-4" style="text-align: right; font-size: 60%">
                        <%= formatTime(LogTruyen[a].created_at.ToString()) %>
                     </div>
         ...
         <!-- tong doanh thu -->
         <div class="div_title">
            <img src="<%=WebTruyenV6.Code.HeThong.url() %>/public/img/www/top-icon/comments.png"  width="40"/><!-- da sua thanh 2 cham  -->
            Bình luận gần đây
         </div>
         <!-- phan noi dung -->
         <div class="maunen_div">
            <div class="row list_truyen">
               <div class="list-binhluan_index">
                  ...
                  <div class="row">
                     <div class="col-8">
                        <p>
                           <img src="<%=WebTruyenV6.Code.HeThong.url() %>/public/img/www/avatar/<%= NguoiDungs.img_user %>"  class="avatar" width="40" onError="this.onerror=null;this.src='<%=WebTruyenV6.Code.HeThong.url() %>/public/img/www/err-img.png';" />
                           <%= NguoiDungs.fullname %>
                        </p>
                     </div>
                     <div class="col-4" style="text-align: right; font-size: 60%">
                        <%=WebTruyenV6.Code.HeThong.TinhThoiGian(BinhLuanNguoiDung[a].created_at) %>
                     </div>
                     ...
                     <div class="txt-binhluan">
                        ...
                        <div class="show-less-div-2">
                           <%= WebTruyenV6.Code.HeThong.TuNhayCam(BinhLuanNguoiDung[a].noidung_cmt)  %> 
                        </div>
                        <% }else{ %>
                        <%= WebTruyenV6.Code.HeThong.TuNhayCam(BinhLuanNguoiDung[a].noidung_cmt) %>
                        <%  } %>
