<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UiCapNhatNguoiDung.ascx.cs" Inherits="WebTruyenV6.Control_NguoiDung.TaiKhoan.UiCapNhatNguoiDung" %>
<script>
...
<section>
    <div class="box_div maunen_div">
        <div class="div_title">
            <img src="<%=WebTruyenV6.Code.HeThong.url() %>/public/img/www/top-icon/contact-list.png" width="40" />
            Thông tin tài khoản
            <!-- da sua thanh 2 cham  -->
        </div>
        <div class="row">
            <div class="col-sm-4">
                <div class="d-flex justify-content-center">
                    <div class="avatar-nguoidung" style="margin-top: 20px;">
                        <img class="img-avatar" src="<%=WebTruyenV6.Code.HeThong.url() %>/public/img/www/avatar/<%= NguoiDungs.img_user %>" onError="this.onerror=null;this.src='<%=WebTruyenV6.Code.HeThong.url() %>/public/img/www/avatar/avatar.jpg';" />
                        <hr>
