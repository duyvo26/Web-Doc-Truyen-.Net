<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UiDangNhap.ascx.cs" Inherits="WebTruyenV6.Control_NguoiDung.TaiKhoan.UiDangNhap" %>
<script>
...
<section>
    <div class="box_div">
        <!-- Thanh tiêu đề -->
        <div class="div_title">
            <img src="<%=WebTruyenV6.Code.HeThong.url() %>/public/img/www/top-icon/login.png"  width="40"/> Đăng Nhập  <!-- da sua thanh 2 cham  -->
        </div>
        <!-- End tiêu đề -->
        <!-- noi dung -->
